    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold">Матч сохранён!</h2>
    ...
    <div className="space-y-6 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="grid grid-cols-2 gap-3">
          ...
          <Input label="Длительность (мин)" type="number" placeholder="90" value={duration} onChange={e => setDuration(e.target.value)} min="1" />
        </div>

        <Input
          label="Соперники / Партнёры (необязательно)"
          placeholder="напр. Мария и Карлос"
          value={opponent}
        ...
        <Textarea
          ...
          placeholder="Интересные моменты, что улучшить..."
          value={notes}
